...
<form action="" method="post">
    <div class="modal-body">
        ...
        <div class="form-group row">
            <div class="col-md-3">
                <label class="col-form-label">Nama Peralatan Kantor</label>
            </div>
            <div class="col-md-8">
            @php
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                ...
                $detail= $details->trsDetail->first();
            @endphp
                    <input type="text" name="id_trs_prkt" id="id_trs_prkt" class="form-control" value=" {{ $details->data_keterangan;}}" placeholder="" readonly>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-md-3">
