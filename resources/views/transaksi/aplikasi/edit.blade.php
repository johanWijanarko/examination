            ...
            <div class="col-lg-12 col-12  stretch-card grid-margin">
                <div class="card card-img-holder">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Transaksi Aplikasi</h4>
                        ...
                        @endif
                        <form method="post" action="{{ url('transaksi_data/aplikasi_trans/update', $trsAplikasi->trs_id) }}" class="needs-validation-pegawai" id="save_data" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="id_trs_prkt" id="id_trs_prkt" class="form-control" value="{{ $trsAplikasi->trs_kode }}" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="keterangan" id="keterangan" value="{{ $trsAplikasi->trs_name }}" class="form-control" placeholder="" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="aplikasi" name="aplikasi" required>
                                        ...
                                        <option {{ ($trsAplikasi->trs_data_id == $aplikasi->data_manajemen_id ) ? 'selected' : ''}}  value="{{$aplikasi->data_manajemen_id}}" >{{ $aplikasi->data_manajemen_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="jumlah" id="jumlah" value="{{ $trsAplikasi->trsHasData->data_manajemen_jumlah }}" class="form-control" placeholder="" readonly>
                                </div>
                            </div>
                            <p>
                            ...
                            <div class="collapse" id="collapseExample">
                                <div class="card card-body" style="background-color: #F4F7FA">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="merk" id="merk" value="{{ $trsAplikasi->trsHasData->manajemenHasMerk->nama_data_merk }}" class="form-control" placeholder="" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="type" id="type" value="{{ $trsAplikasi->trsHasData->manajemenHasType->nama_data_type }}" class="form-control" placeholder="" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="kondisi" id="kondisi" value="{{ $trsAplikasi->trsHasData->manajemenHasKondisi->nama_data_kondisi }}" class="form-control" placeholder="" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" name="supplier" id="supplier" value="{{ $trsAplikasi->trsHasData->manajemenHasSupplier->supplier_name }}" class="form-control" placeholder="" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                   <select class="form-control" id="pegawai" name="pegawai" required>
                                        ...
                                        @foreach ($dataPegawai as $pegawai)
                                            <option {{ ($trsAplikasi->trs_pegawai_id ==  $pegawai->pegawai_id) ? 'selected' : '' }} value="{{ $pegawai->pegawai_id }}">{{ $pegawai->pegawai_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="hidden" class="form-control" name="bagian_" id="bagian_"  value="{{ $trsAplikasi->trsHasBagian->bagian_id }}" readonly>
                                    <input type="text" class="form-control" name="bagian" id="bagian"  value="{{ $trsAplikasi->trsHasBagian->nama_bagian  }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-8">
                                    <input type="hidden" class="form-control" name="subBagian_" id="subBagian_" value="{{ $trsAplikasi->trsHasSubBagian->sub_bagian_id }}" readonly>
                                    <input type="text" class="form-control" name="subBagian" id="subBagian"  value="{{ $trsAplikasi->trsHasSubBagian->sub_bagian_nama }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="gedung" name="gedung" required>
                                        ...
                                        @foreach ($gedung as $gdg)
                                            <option {{ ($trsAplikasi->trs_gedung_id ==  $gdg->data_gedung_id) ? 'selected' : '' }} value="{{ $gdg->data_gedung_id }}">{{ $gdg->nama_data_gedung }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="ruangan" name="ruangan" required>
                                        ...
                                        @foreach ($ruangan as $ru)
                                            <option {{ ($trsAplikasi->trs_ruangan_id ==  $ru->data_ruangan_id) ? 'selected' : '' }} value="{{ $ru->data_ruangan_id }}">{{ $ru->nama_data_ruangan }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="kelompok" name="kelompok" required>
                                        ...
                                        @foreach ($kelompok as $kel)
                                            <option {{ ($trsAplikasi->trs_kelompok_id == $kel->data_kelompok_id ) ? 'selected' : '' }} value="{{ $kel->data_kelompok_id }}">{{ $kel->nama_data_kelompok }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    // $('#perangkat').select2();
    $('#pegawai,#kelompok ,#ruangan,#gedung').select2();
});
