            ...
            <div class="col-lg-12 col-12  stretch-card grid-margin">
                <div class="card card-img-holder">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Transaksi Aplikasi</h4><br>
                        ...
                        @endif
                        <form method="post" action="{{ route('update_trs_aplikasi', $detail->trs_id) }}" class="needs-validation-pegawai" id="save_data" enctype="multipart/form-data">
                            {{ csrf_field() }}
...
$(document).ready(function () {
  ...
  $('#addBtn').on('click', function () {
    ...
    $('#tbody').append(`<tr id="R${++rowIdx}">
        ...
        $("#R"+rowIdx).find('.aplikasi_insert').select2();
