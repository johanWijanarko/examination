            ...
            <div class="col-lg-12 col-12  stretch-card grid-margin">
                <div class="card card-img-holder">
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{ url('m_data/aplikasi/update', $getData->data_manajemen_id) }}" class="needs-validation-pegawai" id="save_data" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="nama_aplikasi" id="nama_aplikasi" class="form-control" value="{{ $getData->data_manajemen_name }}" placeholder="" required>
