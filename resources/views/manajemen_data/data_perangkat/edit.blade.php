            ...
            <div class="col-lg-12 col-12  stretch-card grid-margin">
                <div class="card card-img-holder">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit Perangkat</h4>
                        ...
                        @endif
                        <form method="post" action="{{ url('m_data/perangkat/update', $getData->data_manajemen_id) }}" class="needs-validation-pegawai" id="save_data" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="nama_perangkat" id="nama_perangkat" class="form-control" value="{{ $getData->data_manajemen_name }}" placeholder="" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" name="jumlah" id="jumlah" class="form-control" value="{{ $getData->data_manajemen_jumlah }}" placeholder="" >
                                    <div class="invalid-feedback">
                                        Masukkan Jumlah
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <a href="{{ url('m_data/perangkat') }}" class="btn btn-info">Kembali</a>
