            ...
            <div class="col-lg-12 col-12  stretch-card grid-margin">
                <div class="card card-img-holder">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Tambah Peralatan Kantor</h4>
                        <div class="alert alert-danger print-error-msg" style="display:none">
                            <ul></ul>
                        </div>
                        <form method="post" action="{{ url('m_data/alat_kantor/save') }}" class="needs-validation-pegawai" id="save_data" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="nama_atk" id="nama_atk" class="form-control" value="{{old('nama_atk')}}" placeholder="" required>
