        ...
        <div class="row">
            <div class="col-lg-12 col-12  stretch-card grid-margin">
                <div class="card card-img-holder">
                     <div class="card-header" style="background-color: rgb(230, 240, 209)"><h5>Edit Role Akses</h5></div>
                    <div class="card-body">
                        {{-- <h5 class="card-title"> Role Aksest</h5> --}}
                        @if ($errors->any())
                                                ...
                                                @endphp
                                                    ...
                                                    <tr>
                                                        ...
                                                        @foreach ($premis as $item)
                                                            <td>
                                                                <input type="checkbox" name="permission[]" value="{{ $item->id }}" {{ in_array($item->id, $rolePermissions) ? 'checked' : '' }} id="customSwitch{{ $item->id }}">
                                                            </td>
                                                        @endforeach
                                                    </tr>
                                                    @foreach ($childs as $child)
                                                        ...
                                                        <tr>
                                                            ...
                                                            @foreach ($premis2 as $item2)
                                                                <td>
                                                                    <input type="checkbox" name="permission[]" value="{{ $item2->id }}" {{ in_array($item2->id, $rolePermissions) ? 'checked' : '' }} id="customSwitch{{ $item2->id }}">
                                                                </td>
                                                            @endforeach
                                                        </tr>
                                                    @endforeach
