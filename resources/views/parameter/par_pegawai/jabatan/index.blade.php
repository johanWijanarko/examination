...
<div class="card">
    <div class="card-body">
       <div>
            <h5>Daftar Jabatan SPI</h5>
        </div><br>
        <div class="input-group-append" style="float: right; margin-bottom: 10px; " >
          <a class="btn btn-outline-success btn-outline-oke" href="{{ route('tambahjabatan') }}">Tambah</a>
...
$(function() {
    $('#jabatan').DataTable({
        ...
        serverSide: true,
         responsive: true,
        ajax: '{{ url('parameter/pegawaispi/getjabatan') }}',
        columns: [
          { "data": 'DT_RowIndex',orderable: false, searchable: false },
             { data: 'jenis_jabatan_name', name: 'jenis_jabatan_name' },
