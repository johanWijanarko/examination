...
<head>
    @php
        ...
        header("Content-Disposition: attachment;filename=rekap-pengembalian-atk". rand().".xls");
    ...
    <body>
            ...
            <table class="table table-bordered table-striped table-inka" id="data_perangkat">
                <tr class="noBorder">
                    <th colspan="13" style="font-size: 16px !important; ">
                    
                    </th>
                </tr>
                <tr class="noBorder">
                    <th colspan="13" style="font-size: 16px !important;">
                    Laporan Rekapitulasi Pengembalian Peralatan Kantor 
                    </th>
                </tr>
                    <tr>
                        <th>No</th>
                    ...
                    @foreach ($datakembali as $i=> $lap)
                        <tr>
                            ...
                            <td>{{ $lap->kembaliHasTrs->trsHasGedung->nama_data_gedung }}</td>
