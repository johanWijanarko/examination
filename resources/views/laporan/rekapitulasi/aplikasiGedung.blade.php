...
<div class="card">
    <div class="card-header" style="text-align: center !important">
       <h5>Laporan Rekapitulasi Data Aplikasi Per Gedung</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12 mt-4" style="font-size: 12px !important">
                <form action="{{ route('rekapAplGedung') }}" action="get">
...
<div class="card">
    <div class="card-body">
                ...
                <tbody>
                    @foreach ($aplikasi as $i=> $apl)
                        <tr>
                            ...
                            @endphp
                            <td>{{ $apl->trsHasGedung->nama_data_gedung }}</td>
        ...
        <div class="row-lg-12" style="align-content: center;">
            <form action="{{ route('rekapAplGedungExcel') }}" method="GET" id="v_excel2">
                {{ csrf_field() }}
