...
<div class="card">
    <div class="card-header" style="text-align: center !important">
       <h5>Laporan Rekapitulasi Pengembalian Aplikasi</h5>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-12 mt-4" style="font-size: 12px !important">
                <form action="{{ route('rekap_kem_aplikasi') }}" action="get">
...
<div class="card">
    <div class="card-body">
        ...
        <div class="row-lg-12" style="align-content: center;">
            <form action="{{ route('rekap_kem_aplikasi_excel') }}" method="GET" id="v_excel2">
                {{ csrf_field() }}
