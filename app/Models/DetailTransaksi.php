...
class DetailTransaksi extends Model
{
    ...
    protected $fillable = ['trs_detail_id','trs_id', 'trs_detail_pegawai_id', 'trs_detail_data_stok_id', 'trs_detail_gedung_id', 'trs_detail_ruangan_id', 'trs_detail_jumlah', 'trs_detail_status'];
