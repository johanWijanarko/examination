...
class MutasiHasDetail extends Model
{
    ...
    protected $fillable = ['detail_id','detail_mutasi_id', 'detail_mutasi_trs_id', 'detail_mutasi_pegawai_id','detail_mutasi_bagian_id','detail_mutasi_sub_bagian_id', 'detail_mutasi_gedung_id', 'detail_mutasi_ruangan_id', 'detail_mutasi_kondisi_id','detail_mutasi_tgl', 'mutasi_tgl','created_at', 'updated_at'];

    public function DetailMutasiHasPegawai()
    {
        return $this->belongsTo(PegawaiModels::class, 'detail_mutasi_pegawai_id', 'pegawai_id');
    }
    public function DetailMutasiHasBagian()
    {
        return $this->belongsTo(ParBagianModels::class, 'detail_mutasi_bagian_id', 'bagian_id');
    }
    public function DetailMutasiHasSubBagian()
    {
        return $this->belongsTo(SubBagianModels::class, 'detail_mutasi_sub_bagian_id', 'sub_bagian_id');
    }
