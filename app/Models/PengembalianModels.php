...
class PengembalianModels extends Model
{
    ...
    protected $fillable = ['pengembalian_id', 'pengembalian_data_id', 'pengembalian_obejk_id','pengembalian_pegawai_id', 'pengembalian_kondisi_sekarang_id', 'pengembalian_kondisi_sebelum_id','pengembalian_jumlah', 'pengembalian_keterangan','pengembalian_trs_id','pengembalian_pic_id','pengembalian_tgl','created_at', 'updated_at'];
