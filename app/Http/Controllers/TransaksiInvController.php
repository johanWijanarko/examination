...
class TransaksiInvController extends Controller
{
    ...
    {
        $trsInv = TransaksiModels::with(['trsHasStok','trsDetail' =>function ($q){
    ...
    public function save(Request $request)
    {
        ...
        [
            ...
            'inventaris.required' => ' Aplikasi tidak boleh kosong!',
        ]);

        $save = [
            'trs_kode'=> $request->id_trs_prkt,
            'trs_keterangan'=> $request->keterangan,
            'trs_data_stok_id'=> $request->inventaris,
            'trs_date'=> $tgl,
        ];
        ...
        if ($request->pegawai) {
            foreach ($request->pegawai as $key => $data) {
                ...
                $stok = StokModels::where('data_stok_id',$request->inventaris);
    ...
    public function update(Request $request , $id)
    {
        ...
        [
            'keterangan.required' => 'Keterangan tidak boleh kosong!',
            'tgl.required' => ' Tanggal tidak boleh kosong!',
            'inventaris.required' => ' Inventaris tidak boleh kosong!',
        ]);
