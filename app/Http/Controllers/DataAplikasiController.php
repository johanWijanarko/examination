...
class DataAplikasiController extends Controller
{
    public function index(){
        return \view('manajemen_data/data_aplikasi.index');
    }
    public function getDataAplikasi(Request $request){
        ...
        ->orderBy('data_manajemen_id', 'asc')->where('data_manajemen_kode_id',2)->get();

        return DataTables::of($DataPerangkat)
            ->addColumn('actions', 'manajemen_data/data_aplikasi.actions')
    ...
    public function tambah(Request $request){
        ...
        return \view('manajemen_data/data_aplikasi.tambah',compact('parMerks', 'parType', 'parKondisi',  'parSuppliers'));
    }
    ...
    public function save(Request $request){
        ...
        $save = [
            'data_manajemen_kode_id'=> 2,
            'data_manajemen_name' => $request->nama_aplikasi,
        ...
        $query = end($query);
        $this->save_log('tambah aplikasi' ,json_encode($query ));

        Alert::success('Success', 'Data berhasil di Simpan');
        return redirect('m_data/aplikasi');
    }
    public function edit($id){
        ...
        return \view('manajemen_data/data_aplikasi.edit',compact('getData', 'parMerks', 'parType', 'parKondisi', 'parSuppliers'));
        // dd($getData);
    }
    ...
    public function update(Request $request, $id){
        ...
        $query = DB::getQueryLog();
        $query = end($query);
        $this->save_log('update aplikasi' ,json_encode($query ));
    ...
    public function confrimDelete($id){
        $getData = DataManajemenModels::find($id);
        return \view('manajemen_data/data_aplikasi.delete',compact('getData'));
    }
    ...
    public function delete($id){
        ...
        $query = DB::getQueryLog();
        $query = end($query);
        $this->save_log('delete aplikasi' ,json_encode($query ));
