...
class DataAlatKantorController extends Controller
{
    public function index(){
        return \view('manajemen_data/data_alat_kantor.index');
    }
    public function getDataAtk(Request $request){
        ...
        ->orderBy('data_manajemen_id', 'asc')->where('data_manajemen_kode_id',3)->get();

        return DataTables::of($DataPerangkat)
            ->addColumn('actions', 'manajemen_data/data_alat_kantor.actions')
    ...
    public function tambah(Request $request){
        ...
        return \view('manajemen_data/data_alat_kantor.tambah',compact('parMerks', 'parType', 'parKondisi',  'parSuppliers'));
    }
    ...
    public function save(Request $request){
        ...
        [
            'nama_atk.required' => 'Nama Perangkat tidak boleh kosong!',
        ...
        $save = [
            'data_manajemen_kode_id'=> 3,
            'data_manajemen_name' => $request->nama_atk,
        ...
        $query = end($query);
        $this->save_log('tambah peralatan kantor' ,json_encode($query ));


        Alert::success('Success', 'Data berhasil di Simpan');
        return redirect('m_data/alat_kantor');
    }
    public function edit($id){
        ...
        return \view('manajemen_data/data_alat_kantor.edit',compact('getData', 'parMerks', 'parType', 'parKondisi',  'parSuppliers'));
        // dd($getData);
    }
    ...
    public function update(Request $request, $id){
        ...
        $query = DB::getQueryLog();
        $query = end($query);
        $this->save_log('update peralatan kantor' ,json_encode($query ));
    ...
    public function confrimDelete($id){
        $getData = DataManajemenModels::find($id);
        return \view('manajemen_data/data_alat_kantor.delete',compact('getData'));
    }
    ...
    public function delete($id){
        ...
        $query = DB::getQueryLog();
        $query = end($query);
        $this->save_log('delete peralatan kantor' ,json_encode($query ));
